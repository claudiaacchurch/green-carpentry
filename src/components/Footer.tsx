	...
	return (
		<>
				...
				<div className={styles.footerPartners}>
					...
					<div className={styles.partnersLogos}>
						<a href="https://www.tekkwise.com/" className={styles.partnerLogo}>
							<img src={`${base}/media/partnerlogos/tekkwise.png`} alt="TeKKWise" />
						</a>
						<a
							href="https://www.instagram.com/nethercottdrones/"
							className={`${styles.partnerLogo} ${styles.partnerLogoOutlined}`}
						>
							<img src={`${base}/media/partnerlogos/nethercott-drones.png`} alt="Nethercott Drones" />
						</a>
					</div>
				</div>
			...
			<div className={styles.accreditationBar}>
				<a href="https://www.cityandguilds.com/" className={styles.accreditationLogo}>
					<img src={`${base}/media/partnerlogos/city-guilds.png`} alt="City & Guilds" />
				</a>
				...
				<a href="https://architecturaltechnology.com/" className={styles.accreditationLogo}>
