    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.contactBar}>
          ...
          <div className={styles.contactBarActions}>
            <a href={PHONE_HREF} className={styles.primaryBtn}>{PHONE_DISPLAY}</a>
            <a href={EMAIL_HREF} className={styles.secondaryBtn}>{EMAIL}</a>
          </div>
        </section>
      </main>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerContact}>
          <a href={EMAIL_HREF} className={styles.footerContactLink}>{EMAIL}</a>
          <a href={PHONE_HREF} className={styles.footerContactLink}>{PHONE_DISPLAY}</a>
        </div>
      </footer>
    </div>
  );
